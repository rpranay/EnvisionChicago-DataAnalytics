...
def generate_biz_viability_report():
    ...
    final_merge.to_csv('Results/query8_result.csv', encoding='utf-8', index=False)

    print("Business viability report is Generated with the name query_8_result.csv in the Results folder")
